...
namespace RustyCore.ConsoleTable
{
    public class ConsoleTable
    {
        ...
        public void Write(Format format = RustyCore.ConsoleTable.Format.Default)
        {
            switch (format)
            {
                case RustyCore.ConsoleTable.Format.Default:
                    Console.WriteLine(ToString());
                    break;
                case RustyCore.ConsoleTable.Format.MarkDown:
                    Console.WriteLine(ToMarkDownString());
                    break;
                case RustyCore.ConsoleTable.Format.Alternative:
